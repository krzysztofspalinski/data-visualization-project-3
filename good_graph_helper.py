...
def scatter_3d_good_graph(seed=42):
  ...
  yaxes = ['yaxis', 'yaxis2', 'yaxis3', 'yaxis4']

  fig['layout']['xaxis3']['title'] = 'Rok'
  fig['layout']['xaxis4']['title'] = 'Rok'

  fig['layout']['yaxis']['title'] = 'Sprzedaż produtku'
  fig['layout']['yaxis3']['title'] = 'Sprzedaż produtku'

  for xaxis, yaxis in zip(xaxes, yaxes):
      fig['layout'][xaxis]['showgrid'] = False
      fig['layout'][xaxis]['dtick'] = 1
      fig['layout'][yaxis]['showgrid'] = True
      fig['layout'][yaxis]['range'] = [0, 85]
  fig.update_layout(legend=dict(x=0, y=-.2), legend_orientation="h", title='Sprzedaż firm w latach 2010 - 2017')
